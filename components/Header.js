...
tracking-[3px] text=[15px]  items-center uppercase `}>
  ...
  {currentUser ? (
          ...
          <>
            <a href='/login' className='hover:text-accent transition text-primary'>Entrar</a>
            <a href='/singup' className='hover:text-accent transition text-primary'>Cadastrar</a>
          </>
        )}
</nav>
</div>
